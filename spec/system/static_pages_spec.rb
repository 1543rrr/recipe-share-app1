...
RSpec.describe "StaticPages", type: :system do
  describe "トップページ" do
    context "ページ全体" do
      ...
      it "Make every day happy with cookingの文字列が存在することを確認" do
  ...
  describe "ヘルプページ" do
    ...
    it "Make every day happy with cookingとは？の文字列が存在することを確認" do
      expect(page).to have_content 'Make every day happy with cookingとは？'
    end

    it "正しいタイトルが表示されることを確認" do
      expect(page).to have_title full_title('Make every day happy with cookingとは？')
    end
  end
